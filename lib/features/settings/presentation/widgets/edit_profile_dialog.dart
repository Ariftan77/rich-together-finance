...
/// Dialog to edit an existing profile's name and avatar.
...
class _EditProfileDialogState extends ConsumerState<EditProfileDialog> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final isUnique = await profileDao.isProfileNameUnique(
        name,
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(trans.profileUpdated)),
        );
      }
    } catch (e) {
