            ...
            Padding(
              ...
              child: Row(
                children: [
                   Text(
                    'Transactions',
                    style: AppTypography.textTheme.displaySmall, // Fixed
                  ),
                  const Spacer(),
                  // Filter button
                  Consumer(
                      ...
                      return Stack(
                        children: [
                          IconButton(
                            icon: Icon(
                              Icons.filter_list,
                              color: hasDateFilter ? AppColors.primaryGold : Colors.white,
                            ),
                            onPressed: () {
              ...
              children: [
                FutureBuilder<Account?>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Text(
                      '$currencySymbol $prefix${Formatters.formatCurrency(transaction.amount)}',
                      style: AppTypography.textTheme.bodyMedium!.copyWith(
                        color: color,
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
