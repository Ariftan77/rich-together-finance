  ...
  RateResult _getHardcodedRates(String date) {
    return RateResult(
      ...
      rates: {
        ...
        'PHP': 55.80,
        'EUR': 0.92,
        // Extended currencies (rates as of early 2026)
        'GBP': 0.756,
        'INR': 92.70,
        'HKD': 7.83,
        'TWD': 32.11,
        ...
        'BND': 1.28,
        'MOP': 8.06,
        'QAR': 3.64,   // pegged ~3.64
        'KWD': 0.307,
        'OMR': 0.385,  // pegged ~0.385
        'BHD': 0.376,  // pegged ~0.376
        'JOD': 0.709,  // pegged ~0.709
        'RUB': 80.13,
        'UAH': 44.10,
        'KZT': 489.67,
        'MAD': 9.43,
